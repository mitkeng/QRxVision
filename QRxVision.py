...
def process_compound_similarity(compound_name, compound_SMILE, num_top_results=10):
    # --- Cleanup previous run files/folders ---
    try:
    ...
    try:
        ...
        shutil.rmtree("Mole_feat3QR") # Clean up reference QR codes too
    except OSError:
        pass
        ...
        with open(output_file_test_dataset, 'r') as DR_test:
            ...
            for dr_line in DR_test:
                ...
                try:
                    ...
                    test_qr_filename = f"test_QRcode/test_{s}.png"
